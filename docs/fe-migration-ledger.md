...
| notifications | `com.socialapp.notifications` | 6   | BE **không có realtime nào** (không WebSocket, không SSE) → badge chưa đọc chỉ poll 30s được. Xem `findings/notifications.md`                                                                           | done (6/6)       | done (6/6)       | done (6/6)       | not started                                                | not started            | not started (Guardrail B — 0 UI nên chưa có consumer để rewire) | not started |
