...
export default function LibraryPage() {
  ...
  return (
    <div className="flex flex-col gap-[var(--nx-space-section)]">
      ...
      {/* Local state rather than routes, unlike `/friends`: those three tabs were three existing
          URLs that people could already be holding links to, and collapsing them into state would
          have broken those links. These two never had URLs of their own. */}
      <Tabs
