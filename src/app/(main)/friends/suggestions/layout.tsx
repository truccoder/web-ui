 ...
 */
export const generateMetadata = () => pageMetadata((m) => m.friends.suggestions.title);

export default function FriendSuggestionsLayout({ children }: { children: React.ReactNode }) {
  return children;
}
