    ...
    <div className="flex w-full flex-col gap-1.5">
      {label && (
        <label
          htmlFor={inputId}
          className={cn(
            'text-nx-body-sm font-medium text-nx-text-secondary',
            disabled && 'opacity-50'
          )}
        >
          {label}
      ...
      <div
        className={cn(
          'flex w-full items-center gap-2 rounded-nx-sm border bg-nx-surface-card px-3',
          ...
          error ? 'border-nx-status-danger' : 'border-nx-border-strong',
