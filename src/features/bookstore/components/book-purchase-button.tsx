    ...
    <Button
      ...
      onClick={() =>
        createPayment(bookId, {
          onSuccess: (intent) => {
            // `paymentUrl` is read out of MoMo's response map and is genuinely nullable. The legacy
            // version assigned it unconditionally, which navigated the browser to the string
            // "null" when MoMo answered without it. Staying put is the honest failure.
