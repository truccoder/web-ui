export const en = {
  ...
  post: {
    ...
    // Shown when the post was opened from somewhere other than the feed (a profile, notifications,
    // search) — the link goes back to that page, so the word cannot still say "the feed".
    back: 'Back',
    permalink: {
  ...
  projects: {
    ...
    suggested: {
      ...
      qualified: 'You qualify for:',
      emptyTitle: 'No matching projects yet',
      emptyDesc:
        'No project clears the skills and experience bar in your professional profile. Browse the whole board below.',
      fillProfile: 'Complete your professional profile',
    },
    applyAria: 'Apply — ${title}',
    card: {
      minYears: '≥ ${count} yrs',
    },
    jd: {
      view: 'View job description',
      viewAria: 'View job description — ${title}',
      dialogTitle: 'Job description · ${title}',
      download: 'Download PDF',
      loadError: 'Could not open the job description',
      loadErrorHint: 'The file may be rebuilding. Try again in a moment.',
    ...
    position: {
      ...
      titlePlaceholder: 'e.g. Backend Engineer (payments)',
      summaryLabel: 'Role summary',
      summaryPlaceholder:
        'e.g. Own the platform payment services — API design, exact reconciliation, and on-call alongside a team of four.',
      summaryCounter: '${count}/${min} characters minimum',
      summaryCounterOk: '${count} characters',
      responsibilitiesLabel: 'Key responsibilities',
      responsibilitiesHint: 'One per line. At least 2 lines.',
      responsibilityPlaceholder: 'e.g. Design and maintain the payment gateway API',
      requirementsLabel: 'Requirements',
      requirementsHint: 'One per line. At least 2 lines.',
      requirementPlaceholder: 'e.g. 3+ years with Java or Kotlin on a transactional system',
      niceToHaveLabel: 'Nice to have',
      niceToHaveHint: 'Optional. Does not affect candidate suggestions.',
      niceToHavePlaceholder: 'e.g. Worked with Kafka or an event queue',
      addLine: 'Add line',
      removeLine: 'Remove line',
      skillsLabel: 'Required skills',
      skillsHint: 'Press Enter or comma to add. This is what candidate search runs on.',
      skillsPlaceholder: 'e.g. Kotlin, PostgreSQL, Kafka',
      removeSkill: 'Remove skill ${skill}',
      minYearsLabel: 'Minimum years of experience',
      minYearsHint: 'Optional. Candidates below this are dropped from suggestions.',
      seniorityLabel: 'Seniority',
      seniorityHint: 'Optional. Used as a filter when suggesting candidates.',
      seniorityAny: 'No preference',
      quantityLabel: 'How many',
      quantityHint: 'People needed for this role.',
      errors: {
        titleRequired: 'Enter a role title.',
        titleTooLong: 'Role title is at most 255 characters.',
        summaryRequired: 'Enter a role summary.',
        summaryTooShort: 'The summary needs at least 40 characters.',
        summaryTooLong: 'The summary is at most 2000 characters.',
        listTooFew: 'At least 2 lines are needed.',
        listTooMany: 'At most 15 lines.',
        listItemTooLong: 'Each line is at most 300 characters.',
        skillsRequired: 'Add at least 1 skill.',
        skillsTooMany: 'At most 20 skills.',
        skillTooLong: 'Each skill is at most 60 characters.',
        niceToHaveTooMany: 'At most 10 nice-to-have items.',
        yearsRange: 'Years must be between 0 and 50.',
      },
    },
    ...
    create: {
      ...
      desc: 'Describe the project and the roles you need. Each role is a full job description.',
      ...
      descriptionRequired: 'Enter a project description.',
      positions: 'Roles',
      positionsNote:
        'Required skills are what candidate search runs on — a role with no skills is rejected.',
      roleN: 'Role ${n}',
      ...
      team: {
        ...
        note: 'Written once, shared by every role on the project.',
        overviewLabel: 'Company / team overview',
        overviewPlaceholder:
          'e.g. A team of 12 building a Vietnamese-language coding platform, profitable since 2025.',
        cultureLabel: 'How the team works',
        culturePlaceholder:
          'e.g. Remote, few meetings, thorough reviews. Documentation over verbal handoff.',
        tooLong: 'At most 4000 characters.',
      },
    },
  },
  blocks: {
