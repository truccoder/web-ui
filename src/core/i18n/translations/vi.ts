...
export const vi: Messages = {
  ...
  post: {
    ...
    // Shown when the post was opened from somewhere other than the feed (a profile, thông báo,
    // tìm kiếm) — the link goes back to that page, and the word must not still say "bảng tin".
    back: 'Quay lại',
    permalink: {
  ...
  projects: {
    ...
    suggested: {
      ...
      qualified: 'Phù hợp:',
      emptyTitle: 'Chưa có dự án nào khớp',
      emptyDesc:
        'Chưa có dự án nào khớp đủ kỹ năng và mức kinh nghiệm trong hồ sơ nghề nghiệp của bạn. Xem toàn bộ bảng dự án bên dưới.',
      fillProfile: 'Hoàn thiện hồ sơ nghề nghiệp',
    },
    applyAria: 'Ứng tuyển — ${title}',
    card: {
      minYears: '≥ ${count} năm',
    },
    jd: {
      view: 'Xem mô tả công việc',
      viewAria: 'Xem mô tả công việc — ${title}',
      dialogTitle: 'Mô tả công việc · ${title}',
      download: 'Tải PDF',
      loadError: 'Không mở được mô tả công việc',
      loadErrorHint: 'File có thể đang được dựng lại. Thử lại sau giây lát.',
    ...
    position: {
      ...
      titlePlaceholder: 'Ví dụ: Kỹ sư Backend (mảng thanh toán)',
      summaryLabel: 'Tóm tắt vai trò',
      summaryPlaceholder:
        'Ví dụ: Sở hữu các dịch vụ thanh toán của nền tảng — thiết kế API, đảm bảo đối soát chính xác tuyệt đối, và trực vận hành cùng đội bốn người.',
      summaryCounter: '${count}/${min} ký tự tối thiểu',
      summaryCounterOk: '${count} ký tự',
      responsibilitiesLabel: 'Công việc chính',
      responsibilitiesHint: 'Mỗi dòng một việc. Tối thiểu 2 dòng.',
      responsibilityPlaceholder: 'Ví dụ: Thiết kế và duy trì API cổng thanh toán',
      requirementsLabel: 'Yêu cầu bắt buộc',
      requirementsHint: 'Mỗi dòng một yêu cầu. Tối thiểu 2 dòng.',
      requirementPlaceholder: 'Ví dụ: 3+ năm với Java hoặc Kotlin trong hệ thống giao dịch',
      niceToHaveLabel: 'Điểm cộng',
      niceToHaveHint: 'Không bắt buộc. Không ảnh hưởng tới việc gợi ý ứng viên.',
      niceToHavePlaceholder: 'Ví dụ: Từng làm với Kafka hoặc hàng đợi sự kiện',
      addLine: 'Thêm dòng',
      removeLine: 'Bỏ dòng',
      skillsLabel: 'Kỹ năng yêu cầu',
      skillsHint: 'Nhấn Enter hoặc dấu phẩy để thêm. Đây là thứ dùng để tìm ứng viên.',
      skillsPlaceholder: 'Ví dụ: Kotlin, PostgreSQL, Kafka',
      removeSkill: 'Bỏ kỹ năng ${skill}',
      minYearsLabel: 'Số năm kinh nghiệm tối thiểu',
      minYearsHint: 'Không bắt buộc. Ứng viên dưới mức này bị loại khỏi gợi ý.',
      seniorityLabel: 'Cấp độ',
      seniorityHint: 'Không bắt buộc. Dùng làm điều kiện loại khi gợi ý.',
      seniorityAny: 'Không yêu cầu',
      quantityLabel: 'Số lượng',
      quantityHint: 'Số người cần cho vị trí này.',
      errors: {
        titleRequired: 'Nhập tên vị trí.',
        titleTooLong: 'Tên vị trí tối đa 255 ký tự.',
        summaryRequired: 'Nhập tóm tắt vai trò.',
        summaryTooShort: 'Tóm tắt cần ít nhất 40 ký tự.',
        summaryTooLong: 'Tóm tắt tối đa 2000 ký tự.',
        listTooFew: 'Cần ít nhất 2 dòng.',
        listTooMany: 'Tối đa 15 dòng.',
        listItemTooLong: 'Mỗi dòng tối đa 300 ký tự.',
        skillsRequired: 'Thêm ít nhất 1 kỹ năng.',
        skillsTooMany: 'Tối đa 20 kỹ năng.',
        skillTooLong: 'Mỗi kỹ năng tối đa 60 ký tự.',
        niceToHaveTooMany: 'Điểm cộng tối đa 10 mục.',
        yearsRange: 'Số năm phải từ 0 đến 50.',
      },
    },
    ...
    create: {
      ...
      desc: 'Mô tả dự án và các vị trí bạn cần. Mỗi vị trí là một bản mô tả công việc đầy đủ.',
      ...
      descriptionRequired: 'Nhập mô tả dự án.',
      positions: 'Vị trí tuyển',
      positionsNote:
        'Kỹ năng yêu cầu là thứ dùng để tìm ứng viên — vị trí không có kỹ năng sẽ bị từ chối.',
      roleN: 'Vị trí ${n}',
      ...
      team: {
        heading: 'Về đội ngũ',
        note: 'Viết một lần, mọi vị trí trong dự án dùng chung.',
        overviewLabel: 'Giới thiệu công ty / đội',
        overviewPlaceholder:
          'Ví dụ: Đội 12 người xây nền tảng học lập trình bằng tiếng Việt, doanh thu dương từ 2025.',
        cultureLabel: 'Văn hoá làm việc',
        culturePlaceholder:
          'Ví dụ: Làm từ xa, họp ít, review kỹ. Ưu tiên tài liệu hoá hơn trao đổi miệng.',
        tooLong: 'Tối đa 4000 ký tự.',
      },
    },
  },
  blocks: {
